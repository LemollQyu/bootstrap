!function(e) {
    ...
    if (e(window).on("load", function() {
        ...
        e(".tg__animate-text").each(function() {
            ...
            s.waypoint({
                handler: function() {
                    s.hasClass("stop") || (s.addClass("stop"),
                    setTimeout(function() {
                        s.text(""),
    ...
    e(".tgmenu__wrap li.menu-item-has-children ul").length && e(".tgmenu__wrap .navigation li.menu-item-has-children").append('<div class="dropdown-btn"><span class="plus-line"></span></div>'),
    e(".tgmobile__menu").length) {
        ...
        e(".tgmobile__menu li.menu-item-has-children .dropdown-btn").on("click", function() {
    ...
    s.scroll(function() {
        var e = s.scrollTop();
        e >= i ? t.addClass("tg-sticky-menu") : (t.removeClass("tg-sticky-menu"),
        t.removeClass("sticky-menu__show")),
        t.hasClass("tg-sticky-menu") && (e < a ? t.addClass("sticky-menu__show") : t.removeClass("sticky-menu__show")),
        a = e
    }),
    ...
    e(".tgmenu__action .search").length && (e(".tgmenu__action .search").on("click", function() {
        return e("body").addClass("search__active"),
        !1
    }),
    e(".search__close").on("click", function() {
        e("body").removeClass("search__active")
    })),
    e(".search a, .tg-btn-1, .side-toggle-icon, .mobile-nav-toggler, .dropdown-btn").on("click", ()=>new Audio("assets/audio/click.wav").play()),
    e(".search__close, .offCanvas__toggle, .offCanvas__overlay, .close-btn").on("click", ()=>new Audio("assets/audio/remove.wav").play()),
    e(".about__tab-wrap ul button").on("click", ()=>new Audio("assets/audio/tab.mp3").play()),
    ...
    window.IntersectionObserver) {
        let r = new IntersectionObserver((e,s)=>{
            e.forEach(e=>{
                e.isIntersecting && (e.target.classList.add("active-footer"),
    ...
    function d() {
        if (!jQuery(".tg__heading-wrapper").length)
            return;
    ...
    !function s() {
        if (e(".parallax").length)
            for (var a = document.querySelectorAll(".parallax"), t = 0; t < a.length; t++)
                new Parallax(a[t],{
                    relativeInput: !0,
                    hoverOnly: !0,
                    selector: ".tg-layer",
    ...
    e(".qtybutton-box span").on("click", function() {
        ...
        if (e(this).hasClass("minus")) {
            ...
            (a = a < 1 ? 1 : a) < 2 ? e(this).addClass("dis") : e(this).removeClass("dis"),
            s.val(a)
        } else {
            var a = parseFloat(s.val()) + 1;
            s.val(a),
            a > 1 && e(this).parents(".num-block").find(".minus").removeClass("dis")
        }
        return s.change(),
        !1
    }),
    ...
    e(".services__wrapper .services__item").on("mouseover", function() {
        ...
        s.addClass("active"),
        t.find(".services__images-item").removeClass("active").eq(i).addClass("active")
        ...
        t.find(".tab-pan.active").length > 1 && t.find(".services__images-item").eq(i).removeClass("active")
    }),
    ...
    768 > e(window).width() && e(".roadMap__list li").addClass("mobileView").removeClass("tg__animate-text"),
